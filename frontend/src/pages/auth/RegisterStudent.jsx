...
export default function RegisterStudent() {
  const [form, setForm] = useState({
    email: '', password: '', repassword: '', fullname: '', className: '', school: ''
  });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      navigate('/activate', { state: { email: form.email, mode: 'student_register' } });
    } catch (err) {
    ...
    <div className="auth-container">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="form-group">
          ...
          <input type="text" name="className" value={form.className} onChange={handleChange} required />
        </div>
        <div className="form-group">
          <label>School</label>
