...
export default function StudentSettings() {
  const [profile, setProfile] = useState({ fullname: '', school: '', className: '' });
  ...
  useEffect(() => {
    const fetchProfile = async () => {
      try {
        const res = await api.get('/api/student/settings/profile');
        setProfile({
  ...
  const handleProfileSubmit = async (e) => {
    ...
    setProfileErr('');
    try {
      const res = await api.put('/api/student/settings/profile', profile);
  ...
  const handlePasswordSubmit = async (e) => {
    ...
    try {
      const res = await api.put('/api/student/settings/password', {
